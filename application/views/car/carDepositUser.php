...
<div class="card">
    <div class="card-header bg-dark">
        <div class="row">
            <a class="m-b-0 text-white" style="font-size: 23px; margin-left: 10px;">ประวัติการฝากเช่าของ <?php echo $val->user_fname.' '.$val->user_lname;?></a>
        </div>
    </div>
    <div class="card-body">
